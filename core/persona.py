...
class ChefPersona:
    ...
    def generate_system_prompt(self) -> str:
        ...
        return (
            ...
            "1. `advice_text`: YOU ARE A TRIAGE ASSISTANT. You MUST respond in 2-3 sentences MAX. Place your passionate/chaotic culinary advice ONLY here. NEVER output raw recipe steps or duplicate recipe data inside this string!\n"
            ...
            "   - Option 3: Creative (Flavor Bible 'Chaotic Genius').\n"
            "   ALL technical recipe data belongs exclusively in this array. Never blend it into `advice_text`.\n"
            "4. Your output language MUST dynamically match the user's input language. If ambiguous, default to English.\n"
            "</CRITICAL JSON EXECUTION PIPELINE>"
        )
